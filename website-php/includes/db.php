...
function fede_db_init_schema($existing_pdo = null) {
    ...
    if ($stmt->fetchColumn() == 0) {
        ...
        $ins_les->execute([
            ...
            '18:45',
            'https://www.youtube.com/embed/NGmRSA8aWAk',
        ...
        $ins_les->execute([
            ...
            '24:10',
            'https://www.youtube.com/embed/RDlGX8zYkQ8',
        ...
        $ins_les->execute([
            ...
            '32:00',
            'https://www.youtube.com/embed/civfV2xxrNE',
        ...
        $ins_les->execute([
            ...
            '20:10',
            'https://www.youtube.com/embed/7VNw5QxgJLc',
        ...
        $ins_les->execute([
            ...
            '25:00',
            'https://www.youtube.com/embed/CpVRIFUo-Io',
